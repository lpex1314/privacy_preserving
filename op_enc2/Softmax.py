...
class SoftmaxFunction(torch.autograd.Function):
    ...
    #   def forward(ctx, input: Tensor, dim) -> Tensor:
        ...
        shape_fr, f_r, len_r, float_array_f_r = preprocess(delta_dec)
        shape_delta, delta_c, len_del, float_array_delta = preprocess(delta_enc)
        ...
        # print(output)
        ctx.dim = dim
        ctx.save_for_backward(output, delta_dec, delta_enc)
